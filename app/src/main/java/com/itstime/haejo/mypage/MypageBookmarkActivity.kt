...
import com.itstime.haejo.databinding.ActivityMypageBookmarkBinding
...
class MypageBookmarkActivity : AppCompatActivity() {
    ...
    //data binding
    lateinit var binding : ActivityMypageBookmarkBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMypageBookmarkBinding.inflate(layoutInflater)
